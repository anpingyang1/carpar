    ...
    <div class="zhuce">
    	...
    	<form  method="post" id="registerForm" action="${ctx}/login/register">
        	<div class="zhuce_wid">
                ...
                <div class="f-cb zhuce_tt">
                    <span>验证码：</span>
                    <input id="code1" type="text" autocomplete="off" placeholder="短信验证码" onmouseout="checkCode()"/>
                    <input id="btnSendCode1" type="button" class="btn btn-default" value="获取验证码" style="width:100px;height: 40px" onClick="sendMessage1()" />
